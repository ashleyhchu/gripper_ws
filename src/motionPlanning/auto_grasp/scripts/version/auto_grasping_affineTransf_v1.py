...
pts_obj = np.float32([[0.1494194403030133, -0.6635299375785878], [-0.14278168372248456, -0.6502725640882097], [-0.14684446138135587, -0.44353322857058397]])
pts_arm = np.float32([[0.141, -0.664], [-0.144, -0.648], [-0.140, -0.436]])
M = cv2.getAffineTransform(pts_obj, pts_arm)
# print('Matrix:', M)
