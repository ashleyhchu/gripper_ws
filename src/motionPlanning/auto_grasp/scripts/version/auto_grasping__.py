...
# - Translation: [-0.028, -0.678, 0.029]
# - Rotation: [0.026, 0.998, 0.049, -0.035]
# -----------------------------------------------------------------------------------------------------------------------------------------
# ------------for object position-1------------------
map_x = interp1d( [ 0, -0.08] , [ 0, -0.029] )
map_y = interp1d( [ 0, -0.658] , [ 0, -0.690] )
# -------------------------------------------------------
# ------------for object position-2------------------
# map_x = interp1d( [ 0, -0.167] , [ 0, -0.029] )
# map_y = interp1d( [ 0, -0.472] , [ 0, -0.690] )
# -------------------------------------------------------
xx = np.float(map_x(translation[0]))
yy = np.float(map_y(translation[1]))
