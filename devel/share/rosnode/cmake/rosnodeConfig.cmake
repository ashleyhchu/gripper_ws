...
if("TRUE" STREQUAL "TRUE")
  set(rosnode_SOURCE_PREFIX /home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/rosnode)
  set(rosnode_DEVEL_PREFIX /home/ash/gripper_ws/devel)
  set(rosnode_INSTALL_PREFIX "")
  set(rosnode_PREFIX ${rosnode_DEVEL_PREFIX})
else()
  set(rosnode_SOURCE_PREFIX "")
  set(rosnode_DEVEL_PREFIX "")
  set(rosnode_INSTALL_PREFIX /home/ash/gripper_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/rosnode/${idir}'.  ${_report}")
    endif()
