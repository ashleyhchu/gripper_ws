...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConstantsMultiplex-response>)))
  ...
  (cl:format cl:nil "# test response constants as well~%byte CONFIRM_X=1~%byte CONFIRM_Y=2~%byte CONFIRM_Z=3~%byte select_confirm~%byte ret_byte~%int32 ret_int32~%uint32 ret_uint32~%float32 ret_float32~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConstantsMultiplex-response)))
  "Returns full string definition for message of type 'ConstantsMultiplex-response"
  (cl:format cl:nil "# test response constants as well~%byte CONFIRM_X=1~%byte CONFIRM_Y=2~%byte CONFIRM_Z=3~%byte select_confirm~%byte ret_byte~%int32 ret_int32~%uint32 ret_uint32~%float32 ret_float32~%~%~%"))
