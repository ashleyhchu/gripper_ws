...
if(NOT "/home/ash/gripper_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'droidspeak' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ash/gripper_ws/src/dataAnalysis/droidspeak/${idir}'.  ${_report}")
    endif()
