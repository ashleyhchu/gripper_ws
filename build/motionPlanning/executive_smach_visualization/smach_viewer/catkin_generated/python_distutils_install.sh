...
echo_and_run cd "/home/ash/gripper_ws/src/motionPlanning/executive_smach_visualization/smach_viewer"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ash/gripper_ws/src/motionPlanning/executive_smach_visualization/smach_viewer/setup.py" \
     \
    build --build-base "/home/ash/gripper_ws/build/motionPlanning/executive_smach_visualization/smach_viewer" \
    install \
    --root="${DESTDIR-/}" \
