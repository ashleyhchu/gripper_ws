...
echo_and_run cd "/home/ash/gripper_ws/src/motionPlanning/openai_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ash/gripper_ws/src/motionPlanning/openai_ros/setup.py" \
     \
    build --build-base "/home/ash/gripper_ws/build/motionPlanning/openai_ros" \
    install \
    --root="${DESTDIR-/}" \
