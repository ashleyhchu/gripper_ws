...
echo_and_run cd "/home/ash/gripper_ws/src/motionPlanning/executive_smach/smach"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ash/gripper_ws/src/motionPlanning/executive_smach/smach/setup.py" \
    egg_info --egg-base /home/ash/gripper_ws/build/motionPlanning/executive_smach/smach \
    build --build-base "/home/ash/gripper_ws/build/motionPlanning/executive_smach/smach" \
    install \
    --root="${DESTDIR-/}" \
