...
echo_and_run cd "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/clients/rospy"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/clients/rospy/setup.py" \
     \
    build --build-base "/home/ash/gripper_ws/build/motionPlanning/ros_comm-melodic-devel/clients/rospy" \
    install \
    --root="${DESTDIR-/}" \
