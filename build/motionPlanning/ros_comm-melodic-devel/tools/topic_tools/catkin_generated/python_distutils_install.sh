...
echo_and_run cd "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/topic_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/topic_tools/setup.py" \
     \
    build --build-base "/home/ash/gripper_ws/build/motionPlanning/ros_comm-melodic-devel/tools/topic_tools" \
    install \
    --root="${DESTDIR-/}" \
