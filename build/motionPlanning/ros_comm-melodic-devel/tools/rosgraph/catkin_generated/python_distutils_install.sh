...
echo_and_run cd "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/rosgraph"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/rosgraph/setup.py" \
     \
    build --build-base "/home/ash/gripper_ws/build/motionPlanning/ros_comm-melodic-devel/tools/rosgraph" \
    install \
    --root="${DESTDIR-/}" \
