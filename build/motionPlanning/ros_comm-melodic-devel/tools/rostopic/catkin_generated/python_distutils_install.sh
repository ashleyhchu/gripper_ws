...
echo_and_run cd "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/rostopic"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/rostopic/setup.py" \
     \
    build --build-base "/home/ash/gripper_ws/build/motionPlanning/ros_comm-melodic-devel/tools/rostopic" \
    install \
    --root="${DESTDIR-/}" \
