...
echo_and_run cd "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/rostest"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ash/gripper_ws/src/motionPlanning/ros_comm-melodic-devel/tools/rostest/setup.py" \
     \
    build --build-base "/home/ash/gripper_ws/build/motionPlanning/ros_comm-melodic-devel/tools/rostest" \
    install \
    --root="${DESTDIR-/}" \
