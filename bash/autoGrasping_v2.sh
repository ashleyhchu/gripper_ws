...
for i in {1..1}; do
    ...
    rosrun auto_grasp affineTransf_v2.py       # Approach position
    # va = $(python /affineTransf_v2.py)
    # var=$(python ml_predictions.py)
    echo ${var[0]}
    # rosrun kinova_demo pose_action_client.py -v -r j2n6s300 mdeg -- ? ? 0.036 0.592, 0.800, 0.068, -0.073               # Grasping position
